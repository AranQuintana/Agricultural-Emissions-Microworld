...
function draw(){
    ...
    fill('black');
    textSize(15);
    text('Feed Additives', 500 ,180);
    text('€' + investor.value(), 500 ,250);
    pop();
}
...
function calculate(){
  if (invest == 0){
    values[0] = 14.58;
  } else if (invest < 70000000){
    values[0] = 14.58 / (1 + 0.2 * invest / 70000000);
  } else {
    values[0] = (14.58/1.2) / (1 + 7*(invest-70000000)/4300000000);
  }
}